...
function life_map(size)
{
	...
	this.init_map = function(live_num, istest)
	{
	...
	this.clearMap = function()
	{
		...
		for(i = 0; i < this.mapsize; i++)
		{
			for(j = 0; j < this.mapsize; j++)
			{
				this.ui_map_list[i][j].style.background = "white";
			}
		}
	}
...
var game_timer = {
	...
	init : function(size, num, interval)
	{
		...
		this.gamemap.init_map(this.live_num, this.istest);
